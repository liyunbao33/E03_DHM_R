 ...
 * C/C++ source code generated on : Tue Oct 10 11:13:29 2023
 *
...
#define DHM_IN_Idle_f                  ((uint8_T)7U)
...
void DHM_Step(void)                    /* Explicit Task: DHM_Step */
{
  ...
  uint8_T SO_e_MotorCmd_fa;
  uint8_T SO_e_MotorPwm_e;
  uint8_T SO_e_MotorPwm_h;
  boolean_T SO_b_CorrectPosToMax_d;
  ...
  DHM_LearnLogic(DHM_B.SO_b_HallStall_m, DHM_U.VbINP_CAN_DoorHandleLrnReq_flg_,
                 DHM_U.VeINP_EPRM_FRDoorHandleLrnStsFr, 0,
                 DHM_U.VsINP_HWA_PassHandleHall_sig_Vs, &DHM_B.SO_e_MotorCmd_f,
                 &DHM_B.SO_e_MotorPwm_d, &SO_b_CorrectPosToZero_m,
                 &SO_b_CorrectPosToMax_d, &DHM_B.SO_m_LearnSts_g,
                 &DHM_Y.VsINP_DHM_FRDoorHandleToEE_sig_, &DHM_DW.sf_LearnLogic);
  ...
  DHM_LearnLogic(DHM_B.SO_b_HallStall, DHM_U.VbINP_CAN_DoorHandleLrnReq_flg_,
                 DHM_U.VeINP_EPRM_RRDoorHandleLrnStsFr, 0,
                 DHM_U.VsINP_HWA_RRHandleHall_sig_VsIN, &DHM_B.SO_e_MotorCmd_c,
                 &DHM_B.SO_e_MotorPwm_m, &SO_b_CorrectPosToZero_m,
  ...
  DHM_DoorHndPos(DHM_U.VsINP_HWA_RRHandleHall_sig_VsIN,
                 ...
                 &rtb_SO_m_DoorHndPosSts_h, &DHM_B.SO_s_MaxSoftPos,
   ...
   */
  DHM_CtrlLogic(DHM_DW.UnitDelay4_DSTATE, DHM_U.VsINP_HWA_PassHandleHall_sig_Vs,
                DHM_B.SO_s_MaxSoftPos_b, DHM_B.SO_s_MinSoftPos_i,
                DHM_B.SO_s_IceBrkPos_d, DHM_U.VeINP_CAN_RDoorHandleReq_sig_Ve ==
                1, DHM_U.VeINP_CAN_RDoorHandleReq_sig_Ve == 2,
                DHM_B.SO_m_LearnSts_g, &SO_e_MotorCmd_fa, &SO_e_MotorPwm_h,
   ...
   */
  DHM_MotorLogic(DHM_B.SO_e_MotorCmd_f, DHM_B.SO_e_MotorPwm_d, SO_e_MotorCmd_fa,
                 SO_e_MotorPwm_h, &DHM_B.SO_e_MotorCmd_l,
  ...
  DHM_CtrlLogic(DHM_DW.UnitDelay4_DSTATE_o,
                DHM_U.VsINP_HWA_RRHandleHall_sig_VsIN, DHM_B.SO_s_MaxSoftPos,
                DHM_B.SO_s_MinSoftPos, DHM_B.SO_s_IceBrkPos,
                DHM_U.VeINP_CAN_RRDoorHandleReq_sig_V == 2,
                DHM_U.VeINP_CAN_RRDoorHandleReq_sig_V == 1, DHM_B.SO_m_LearnSts,
                &SO_e_MotorCmd_fa, &SO_e_MotorPwm_h, &SO_b_CorrectPosToZero_m,
   ...
   */
  DHM_MotorLogic(DHM_B.SO_e_MotorCmd_c, DHM_B.SO_e_MotorPwm_m, SO_e_MotorCmd_fa,
                 SO_e_MotorPwm_h, &DHM_B.SO_e_MotorCmd,
...
{
  {
    HndPos_Sts_E rtb_SO_m_DoorHndPosSts_j;
    uint8_T SO_e_MotorCmd_fa;
    uint8_T SO_e_MotorPwm_h;
    boolean_T SO_b_CorrectPosToMax_d;
    ...
    DHM_CtrlLogic_Init(&SO_e_MotorCmd_fa, &SO_e_MotorPwm_h, &SO_b_Error_k);

    /* SystemInitialize for Chart: '<S8>/DoorHndPos' */
    DHM_DoorHndPos_Init(&rtb_SO_m_DoorHndPosSts_j, &DHM_B.SO_s_MaxSoftPos_b,
    ...
    DHM_MotorLogic_Init(&DHM_B.SO_e_MotorCmd_l,
                        ...
                        &DHM_Y.VbOUT_DHM_FRHadFold_flg_VbOUT_D,
                        &SO_e_MotorCmd_fa);
    ...
    DHM_DoorHndPos_Init(&rtb_SO_m_DoorHndPosSts_j, &DHM_B.SO_s_MaxSoftPos,
                        &DHM_B.SO_s_MinSoftPos, &DHM_B.SO_s_IceBrkPos);
    ...
    DHM_MotorLogic_Init(&DHM_B.SO_e_MotorCmd,
                        ...
                        &DHM_Y.VbOUT_DHM_RRHandleFold_flg_VbOU,
                        &SO_e_MotorCmd_fa);
